...
```
python postprrocess.py ${vocal-tract_path} ${glot_path} ${output_dir} --preset=<json> --hparams="parameters you want to override"
```

Postprocess with default parameters is available!
you can run:
```
python3 p.py lj-glot/ljspeech-vt-00001.npy lj-glot/ljspeech-glot-00001.npy  syn
```
